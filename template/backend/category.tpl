...
<hr/>
<p><a href="/index_old.php?page=a$Home">Back to Admin Home</a></p>
<p>Category's</p>
<table border="1">
    <tr>
        <th>ID</th>
    ...
    {foreach from=$categoryList item=category}
        <tr>
            ...
            <td><a href="/index_old.php?page=ap$EditCategory&category={$category->id}${$category->categoryname}">Update/Delete</a></td>
        </tr>
    {/foreach}
    <tr>
        <form action="/index_old.php?page=ac$Category" method="post">
            <td></td>
